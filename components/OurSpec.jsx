...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Nuestros Compromisos' description="En Aima Store te ofrecemos un servicio premium diseñado para que tu experiencia de compra sea segura, rápida y totalmente confiable." />
