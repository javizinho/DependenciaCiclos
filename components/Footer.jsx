    ...
    const linkSections = [
        {
            title: "PRODUCTOS",
            links: [
                { text: "Tecnología y PC", path: '/', icon: null },
                { text: "Audio y Gadgets", path: '/', icon: null },
                { text: "Perfumería de Autor", path: '/', icon: null },
                { text: "Indumentaria Deportiva", path: '/', icon: null },
                { text: "Mobile Center", path: '/', icon: null },
            ]
        },
        {
            title: "MENU",
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-blue-600">aima </span>store
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Bienvenido a AIMA STORE, tu conexión directa con lo mejor del mundo. Desde tecnología de última generación como notebooks y componentes de PC, hasta la exclusividad de perfumes árabes y de nicho. Encontramos para ti la indumentaria más buscada, tanto nacional como internacional. Todo lo que te apasiona, importado y en un solo lugar.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © aima store All Right Reserved.
                </p>
            </div>
        </footer>
    );
